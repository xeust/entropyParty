...
The discount rate presented allows a relative valuation of utility through time, though any valuation attempt still needs to estimate unknown future parameters. Nonetheless, the presented approach differs from prior token valuation methodologies in discounting the utility directly, without first converting the utility value to an alternative numeraire (such as dollars) before discounting. Will the utility discount rate take the market's perception of opportunity costs into account, as cost of capital approaches such as the cost of equity, cost of debt, and weighted average cost of capital methods do? This section will present an approach for answering this question, arguing that these costs are taken into account.
